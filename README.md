...
[![Built on CROO CAP](https://img.shields.io/badge/Built_on-CROO_CAP-f0b90b?style=for-the-badge)](https://cap.croo.network)
...
[![Powered by PulseBNB](https://img.shields.io/badge/Powered_by-PulseBNB-F3BA2F?style=for-the-badge)](https://pulsebnb-web.vercel.app)
...
1. **On paid order**, read the target address from the CAP negotiation requirements.
2. Fetch on-chain facts — bytecode via BNB RPC, ERC-type detection from function selectors, name + verification via block explorer.
3. Classify with AI (Cerebras `gpt-oss-120b`), tuned to separate original builders from recycled noise.
4. Deliver a SCHEMA verdict on-chain; USDC settles to the provider.
...
PulseBNB is the *signal layer* of a two-agent system. Its companion, [**BNB Builder Scout**](https://github.com/Makabeez/builder-scout), is the *reputation layer* — it **pays PulseBNB** to grade a deployer's contracts and composes them into a portable reputation score. One agent hiring another, settled on-chain.
...
- **Live product:** [pulsebnb-web.vercel.app](https://pulsebnb-web.vercel.app) — 40,000+ contracts scanned, ~99% filtered to signal
- **Companion agent:** [BNB Builder Scout](https://github.com/Makabeez/builder-scout)
